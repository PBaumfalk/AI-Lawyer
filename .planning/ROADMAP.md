...
- 🚧 **v0.6.1 Adhoc Bugfixes** — Phase 52 (in progress)
- 📋 **v0.7 UI/UX & Stability** — Phases 53–54 (planned)

## Phases

### 🚧 v0.6.1 Adhoc Bugfixes (In Progress)

**Milestone Goal:** Kritische Nacharbeiten & Sofortfixes ohne neue Feature-Scope.

#### Phase 52: adhoc-bugfixes
**Goal**: Schnellfixe + technische Schulden mit hohem Risikoabbau
**Depends on**: Phase 51
**Requirements**: (ad hoc / aus Bugs)
**Success Criteria** (what must be TRUE):
  1. Kritische Bugs aus Backlog sind behoben oder klar deferred
  2. Tests laufen lokal ohne harte Abhängigkeit (Ollama‑Gate korrekt)
  3. Keine regressions in Kernflows (Akte, E‑Mail, Helena)
**Plans**: TBD

Plans:
- [ ] 52-01: Bug triage & Fix‑Plan
- [ ] 52-02: Fix‑Wave 1 (P0/P1)
- [ ] 52-03: Fix‑Wave 2 (P2/Tech Debt)
