...
5. KI-Entwurf workflow enforcement verification:
   ...
   - The existing ChatNachricht and Dokument models have erstelltDurch field ("ai" | "user" | "system").
   - Verify in process-tasks.ts that all AI outputs set: erstelltDurch="ai", status=ENTWURF (or equivalent).
