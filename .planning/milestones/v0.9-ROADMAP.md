...
- [x] **Phase 63: Tab-Reduktion + Key-Facts-Panel** - Akte detail tabs collapse to 4-5 visible with overflow, sticky key-facts panel above tabs (completed 2026-07-23)
...
- [x] 63-01-PLAN.md — Move KI-Analyse and Falldaten into the overflow menu (4 primary tabs)
- [x] 63-02-PLAN.md — Add Gericht + Status to Key-Facts panel, fix label, make panel sticky
...
| 63 | v0.9 | 2/2 | Complete    | 2026-07-23 |
