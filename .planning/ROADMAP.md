...
Plans:
- [x] 61-01-PLAN.md — Feed filter chips and enum sanitization
- [x] 61-02-PLAN.md — URL tab initialisation with ?tab= param
...
Plans:
- [ ] 62-01-PLAN.md — TELEFONNOTIZ/AUFGABE enum + composer type selector + Telefonnotiz overlay form
